...
@section('title', __('Cetak Nota Pabrik'))
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h3>{{ __('Cetak Nota Pabrik') }}</h3>
                    <p class="text-subtitle text-muted">{{ __('Pilih transaksi untuk dicetak.') }}</p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="/">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('Nota Pabrik') }}</li>
                </x-breadcrumb>
            </div>
        </div>

        <section class="section">
            <form action="{{ route('nota-pabrik.print') }}" method="POST" id="print-form">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('nota-pabrik.index', request()->all()) }}" class="btn btn-primary mt-2"><i class="bi bi-search"></i> Filter</a>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tanggal</th><th>Client</th><th>Mesin</th><th>Produk</th><th>Harga Pabrik</th>
                                </tr>
                            </thead>
                            <tbody>
