...
class NotaPenjualanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('nota-penjualan.index', compact('transaksis', 'clients', 'mesins'));
    }
    ...
    public function print(Request $request)
    {
        ...
        $clientName = $transaksis->first()?->client?->name ?? 'Client';
        ...
        $pdf = Pdf::loadView('nota-penjualan.print', compact('transaksis', 'clientName', 'periode'));
